...
export default class ProductForm {
  ...
  renderProductList = images => images.map(item => {
    const url = escapeHtml(item.url);
    const imgName = escapeHtml(item.source);

    return `
      <li class="products-edit__imagelist-item sortable-list__item" style="">
        <input type="hidden" name="url" value=${url}>
        <input type="hidden" name="source" value=${imgName}>
        <span>
          <img src="./icon-grab.svg" data-grab-handle alt="grab">
          <img class="sortable-table__cell-img" alt=${imgName} src=${url}>
          <span>${imgName}</span>
        </span>
        <button type="button">
      ...
      <form data-element="productForm" class="form-grid">
        ...
        <div class="form-group form-group__wide" data-element="sortable-list-container">
          ...
          <ul class="sortable-list" data-element="imageListContainer">
            ${images ? this.renderProductList(images) : ''}
          </ul>
